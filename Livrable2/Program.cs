...
namespace Liv_In_Paris
{
    class Program
    {
        ...
        static void AjouterClient()
        {
            ...
            //ICI il faut utiliser NomAIdentifiant(string nom)
            //string fichier_connexion = "Connexions.txt";
            //string fichier_StationMetro = "StationsMetro.txt";
            ...
            {
                connection.Open();
                string requeteUtilisateur = "INSERT INTO Utilisateur (idUtilisateur, adresseMail, nom, prenom, adresse, telephone, password) VALUES (@id, @mail, @nom, @prenom, @adresse, @telephone, @password)";
        ...
        static void ModifierClient()
        {
            ...
            //IDEM RAJOUTER STATION LA PLUS PROCHE COMME DANS AJOUTERCLIENT

            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                conn.Open();
                string requeteUti = "UPDATE Utilisateur SET nom=@nom, prenom=@prenom, adresse=@adresse, telephone=@telephone WHERE idUtilisateur=@id;";
                using (MySqlCommand cmd = new MySqlCommand(requeteUti, conn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@adresse", adresse);
                    cmd.Parameters.AddWithValue("@telephone", telephone);
                    // + STATION LA PLUS PROCHE EN PARAMETRE 
                    cmd.ExecuteNonQuery();
                }
        ...
        static void AfficherClients()
        {
            ...
            {
                conn.Open();
                string requeteAffichageC = "SELECT idUtilisateur, nom, prenom, adresse, " +
                ...
                using (MySqlDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        Console.WriteLine("ID: " + reader["idUtilisateur"] + ", Nom: " + reader["nom"] + " " + reader["prenom"] + ", Adresse: " + reader["adresse"] + ", Achats: " + reader["total_achats"] + "€, Commandes: " + reader["nb_commandes"]);
                    }
                }
            }
        }
        ...
        static void AjouterCuisinier()
        {
            ...
            //+ STATION LA PLUS PROCHE COMME DANS AJOUTER CLIENT
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand(requeteUtilisateur, connection))
                {
                    ...
                    cmd.Parameters.AddWithValue("@telephone", telephone);
                    cmd.Parameters.AddWithValue("@password", password);
                    // + STATION LA PLUS PROCHE EN PARAM
                    cmd.ExecuteNonQuery();
                }
        ...
        public static void AfficherPrixCommande()
        {
            ...
            using (MySqlDataReader reader = commande.ExecuteReader())
            {
                if (reader.Read())
                {
                    ...
                    Console.WriteLine("Le prix de la commande " + idCommande + " est de " + prix + "€.");
                }
                else
                {
        ...
        public static void DeterminerTrajetOptimal()
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                (List<int> chemin, double temps) = g2.Dijkstra(stationDepart, stationArrivee);
                ...
                Console.WriteLine("Temps estimé : " + temps + " minutes.");
            }
        }
        ...
        static void AfficherMoyennePrixCommandes()
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                {
                    reader.Read(); 
                    Console.WriteLine("Moyenne des prix des commandes : " + reader["moyennePrix"] + "€");
                }
            }
        }
        ...
        static void AfficherMoyenneComptesClients()
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                {
                    reader.Read(); 
                    Console.WriteLine("Moyenne des soldes des comptes clients : " + reader["moyenneComptes"] + "€");
                }
            }
        }
